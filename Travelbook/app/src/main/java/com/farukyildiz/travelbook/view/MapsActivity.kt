package com.farukyildiz.travelbook.view
...
import com.farukyildiz.travelbook.R
...
import com.farukyildiz.travelbook.databinding.ActivityMapsBinding
import com.farukyildiz.travelbook.model.Place
import com.farukyildiz.travelbook.roomdb.PlaceDao
import com.farukyildiz.travelbook.roomdb.PlaceDatabase
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback ,GoogleMap.OnMapLongClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences=this.getSharedPreferences("com.farukyildiz.travelbook", MODE_PRIVATE)
        trackBoolean=false
        selectedLatLng=LatLng(0.0,0.0)
        registerLauncher()
        val placeDatabase = Room.databaseBuilder(
            applicationContext,
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        if (info=="new")
        {
            ...
            if(ContextCompat.checkSelfPermission(this,Manifest.permission.ACCESS_FINE_LOCATION)!=PackageManager.PERMISSION_GRANTED)
            {
                ...
                {
                    Snackbar.make(binding.root,"Permission needed for location",Snackbar.LENGTH_INDEFINITE).setAction("Give permisson")
                    {
...
//        48.8585324301254, 2.294534942381799
//        val eiffel=LatLng(48.8585324301254,2.294534942381799)
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(eiffel,15f))
    ...
    fun save(view:View)
    {
        val place=Place(binding.nameText.text.toString(),selectedLatLng.latitude,selectedLatLng.longitude)
        compositeDisposable.add(placeDao.insert(place).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(this::handleResponse))
